...
public class FurnaceXPStoragePlugin implements IFMLLoadingPlugin {
	...
	public FurnaceXPStoragePlugin() {
		...
		FermiumRegistryAPI.enqueueMixin(true, "mixins.furnacexpstorage.mysticalagriculture.json", () -> CompatHandler.isModLoaded("mysticalagriculture"));
		FermiumRegistryAPI.enqueueMixin(true, "mixins.furnacexpstorage.nuclearcraft.json", () -> CompatHandler.isModLoaded("nuclearcraft"));
		FermiumRegistryAPI.enqueueMixin(true, "mixins.furnacexpstorage.divinerpg.json", () -> CompatHandler.isModLoaded("divinerpg"));
		FermiumRegistryAPI.enqueueMixin(true, "mixins.furnacexpstorage.simplecore.json", () -> CompatHandler.isModLoaded("simplecore"));
		FermiumRegistryAPI.enqueueMixin(true, "mixins.furnacexpstorage.natura.json", () -> CompatHandler.isModLoaded("natura"));
