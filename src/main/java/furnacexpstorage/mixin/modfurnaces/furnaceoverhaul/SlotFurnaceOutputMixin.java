...
import cazador.furnaceoverhaul.inventory.SlotFurnaceOutput;
...
public abstract class SlotFurnaceOutputMixin extends Slot {
    ...
    @WrapOperation(
            ...
            at = @At(value = "FIELD", target = "Lcazador/furnaceoverhaul/inventory/SlotFurnaceOutput;removeCount:I", ordinal = 1, remap = false)
    )
